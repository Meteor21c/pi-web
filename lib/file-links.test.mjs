...
test("recognizes generated inline file paths without turning shell commands into links", async () => {
  const { looksLikeLocalFileReference, resolveLocalFileReference } = await loadSubject();

  assert.equal(looksLikeLocalFileReference("/Users/me/output/golden-hamster.png"), true);
  assert.equal(
    resolveLocalFileReference("/Users/me/output/golden-hamster.png", "/Users/me/project"),
    "/Users/me/output/golden-hamster.png",
  );
  assert.equal(
    resolveLocalFileReference("report.pdf:12", "/Users/me/project"),
    "/Users/me/project/report.pdf",
  );
  assert.equal(resolveLocalFileReference("rm database.db", "/Users/me/project"), null);
  assert.equal(resolveLocalFileReference("https://example.com/file.pdf", "/Users/me/project"), null);
});
