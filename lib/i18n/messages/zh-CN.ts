...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "brand.download.title": "MeteorAgent 桌面助手",
    "brand.download.description": "在本地项目中使用你的流星 API 中转，下载 MeteorAgent 桌面助手即可开始。",
    "brand.download.action": "下载 MeteorAgent",
    "brand.download.short": "获取桌面版",
