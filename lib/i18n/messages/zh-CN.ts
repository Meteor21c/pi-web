...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "i18n.pluginCommunityDescription": "从 Pi 包目录中精选的低风险插件。",
    ...
    "i18n.pluginLowRiskNotice": "按风险顺序展示：先显示技能和提示词，再显示可执行的工具候选。主题、快捷键、TUI、动画和 Provider 插件暂不显示。",
    "i18n.pluginDetails": "详情",
    "i18n.pluginInstallFromCommunity": "安装",
    "i18n.pluginNoCommunityResults": "没有匹配此筛选条件的社区插件。",
    "i18n.pluginComplexHidden": "复杂插件已从这个精选视图中隐藏。",
