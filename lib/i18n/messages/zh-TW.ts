...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "i18n.pluginCommunityDescription": "從 Pi 套件目錄中精選的低風險外掛。",
    ...
    "i18n.pluginLowRiskNotice": "依風險順序顯示：先顯示技能和提示詞，再顯示可執行的工具候選。主題、快速鍵、TUI、動畫和 Provider 外掛暫不顯示。",
    "i18n.pluginDetails": "詳細資料",
    "i18n.pluginInstallFromCommunity": "安裝",
    "i18n.pluginNoCommunityResults": "沒有符合此篩選條件的社群外掛。",
    "i18n.pluginComplexHidden": "複雜外掛已從這個精選檢視中隱藏。",
