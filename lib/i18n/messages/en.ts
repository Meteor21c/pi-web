...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "brand.download.title": "MeteorAgent desktop assistant",
    "brand.download.description": "Use your meteor21c relay from local projects with the MeteorAgent desktop assistant.",
    "brand.download.action": "Download MeteorAgent",
    "brand.download.short": "Get the desktop app",
