...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "appUpdate.title": "A new MeteorAgent version is available",
    "appUpdate.versionLine": "Current {current} → New {latest}",
    "appUpdate.changes": "What's new",
    "appUpdate.defaultNote": "Performance, stability, and usability improvements",
    "appUpdate.dataSafe": "The update replaces only the Magent application. Accounts, conversations, plugins, project files, and unsent drafts are preserved.",
    "appUpdate.runningTasks": "{count} task(s) are still running. Update after they finish.",
    "appUpdate.preparing": "Preparing the update",
    "appUpdate.later": "Remind me later",
    ...
    "appUpdate.latest": "You have the latest version, v{version}",
    "appUpdate.found": "New version v{version} found",
    "appUpdate.checkFailed": "Unable to check for updates. Try again later.",
    "appUpdate.rollbackMessage": "The new version did not start. Magent may have restored the previous version; check the update log or download the launcher again.",
    "appUpdate.notStartedMessage": "The updater did not restart MeteorAgent. The current version is still running; check the update log and try again.",
    "sidebar.hide": "Hide sidebar",
    "sidebar.show": "Show sidebar",
    "restart.action": "Restart Magent",
    "restart.description": "Restart the local service; this page will reconnect automatically",
    "restart.confirm": "Restart Magent now?\n\nMake sure no task is running first. The service will disconnect briefly and recover automatically; accounts, conversations, and project files will not be deleted.",
    "restart.unsupported": "Run MeteorAgent through its launcher to use local restart",
    "restart.runningTasks": "{count} task(s) are still running",
    "restart.preparing": "Restarting…",
    "restart.waiting": "The service is coming back; this page will reconnect automatically…",
    "restart.failed": "Restart did not complete. Check the service and try again.",
    ...
    "system.prompt": "Assistant rules (read-only)",
    "system.empty": "Assistant rules are empty (tools are disabled)",
    "system.load": "Assistant rules have not loaded yet",
    "system.loading": "Loading assistant rules…",
    "system.label": "Assistant rules",
    "system.description": "These are the rules Magent currently follows, assembled from app settings, project instructions, and enabled tools. No changes are needed for ordinary chats.",
    ...
    "sidebar.selectProject": "Select project documents folder…",
    "sidebar.projectAddress": "Project documents location",
    "sidebar.projectAddressHint": "Magent only reads and changes project files here. New chats are created in the current folder.",
    ...
    "chat.activityTitle": "Magent is working",
    "chat.activityModelThinking": "The model is generating visible thinking content…",
    "chat.activityWriting": "Preparing the reply…",
    "chat.activityReading": "Reading files…",
    "chat.activityEditing": "Editing files…",
    "chat.activitySearching": "Searching the web…",
    "chat.activityGeneratingImage": "Generating an image…",
    "chat.activityUsingComputer": "Using the computer…",
    "chat.activityProcessingDocument": "Processing a document…",
    "chat.thinkingBlockTitle": "Thinking content",
    "chat.thinkingPending": "Waiting for visible content…",
    "chat.thinkingVisibilityHint": "Only content returned by the model is shown. Click to expand or collapse.",
    ...
    "chat.pendingMessages": "Pending messages · {count}",
    "chat.steeringCurrent": "Steering the current response",
    "chat.steeringCurrentHint": "Injected after the current tool step, without waiting for the whole run",
    "chat.followUpQueued": "Follow-up queued",
    "chat.followUpQueuedHint": "Sent as the next message after the current run finishes",
    ...
    "chat.slashHelp": "Direct actions run now; skills and prompts are sent to the assistant",
    "chat.tabEnter": "Tab / Enter",
    "chat.noCommands": "No available commands or assistant skills found",
    "chat.match": "1 match",
    ...
    "chat.capabilitiesAndFiles": "Skills, plugins & files · {label}{hint}",
    "chat.noMatchingCapabilitiesOrFiles": "No matching skill, plugin command, or file",
    "chat.skill": "Skill",
    "chat.pluginCommand": "Plugin command",
    "chat.pluginTool": "Plugin tool",
    "chat.usePluginTool": "Use plugin tool `{name}`:",
    "chat.findCapabilities": "Find skills, plugin commands, or project files",
    ...
    "chat.steerPlaceholder": "Type to steer this response or queue a follow-up…",
    "chat.agentPlaceholder": "Agent is running…",
    "chat.messagePlaceholder": "Message… Type / for commands, @ for skills, plugins, or files",
    "chat.welcomeMorning": "Good morning",
    "chat.welcomeAfternoon": "Good afternoon",
    "chat.welcomeEvening": "Good evening",
    "chat.welcomeTips": "Try asking",
    "chat.welcomeTip1": "Explain this project's directory structure",
    "chat.welcomeTip2": "Help me find the cause of a recent error",
    "chat.welcomeTip3": "Write unit tests for this code",
    "settings.uiScale": "Interface scale",
    "settings.uiScaleDescription": "Scale UI text and components on high-resolution displays (2K/4K)",
    "settings.uiScaleAuto": "Auto",
    "chat.steer": "Steer response",
    "chat.followUp": "Follow-up",
    "chat.steerHint": "Inject into the current response after the current tool step",
    ...
    "chat.attachFiles": "Add files or images",
    "chat.uploadingFiles": "Adding files to the current project…",
    "chat.filesAdded": "Added {count} file(s) to this message",
    "chat.fileUploadFailed": "Could not add the files. Try again.",
    "chat.fileUploadNeedsProject": "Choose a project folder before adding files",
    "chat.previewImage": "Preview image",
    "chat.openFile": "Open in Magent: {file}",
    "chat.filterModels": "Filter models…",
    "chat.noMatchingModels": "No matching models",
    "chat.modelGroups": "Groups",
    "chat.modelsInGroup": "Models in group",
    ...
    "chat.skills": "Skills",
    "chat.builtInCommands": "System commands",
    "chat.extensionCommands": "Direct actions",
    "chat.promptTemplates": "Prompt templates",
    "chat.assistantSkills": "Assistant skills",
    "chat.directAction": "Runs directly",
    "chat.assistantInstruction": "For assistant",
    "chat.imageDirectCommandLabel": "Image generation (legacy)",
    "chat.imageSkillCommandLabel": "Generate an image",
    "chat.imageDirectCommandDescription": "Legacy command: reports the saved image path instead of showing the image in chat. Use the assistant skill when available.",
    "chat.imageSkillCommandDescription": "Enter a description after this command; the assistant calls the image tool and shows the result in chat.",
    ...
    "chat.imageModelLabel": "Image · {model}",
    "chat.selectImageModel": "Select image model",
    "chat.selectSessionImageModel": "Select the image model for this conversation",
    ...
    "branch.switchHint": "Choose a conversation branch and continue from that version",
    ...
    "i18n.showSvgSource": "Show SVG source",
    "i18n.previewSvg": "Preview SVG image",
    "i18n.svgImage": "SVG image",
    ...
    "i18n.pluginViews": "Plugin views",
    "i18n.pluginCommunity": "Community",
    "i18n.pluginInstalled": "Installed",
    "i18n.pluginInstalledCount": "{count} installed plugins",
    "i18n.pluginCommunityDescription": "Automatically synced from Pi's official community catalog, with source and permission risks shown before install.",
    "i18n.pluginOpenCatalog": "Open full catalog",
    "i18n.pluginCategory": "Plugin category",
    "i18n.pluginCategoryAll": "All",
    "i18n.pluginCategorySkill": "Skills",
    "i18n.pluginCategoryPrompt": "Prompts",
    "i18n.pluginCategoryTool": "Tool candidates",
    "i18n.pluginSearchPlaceholder": "Search community plugins…",
    "i18n.pluginCatalogLive": "Synced {count} plugins from the official catalog · {time}",
    "i18n.pluginCatalogCached": "Using the latest cached catalog of {count} plugins · {time}",
    "i18n.pluginCatalogSyncing": "Syncing the community catalog…",
    "i18n.pluginCatalogStaleWarning": "The official catalog could not be refreshed. The latest successful sync is still shown.",
    "i18n.pluginCatalogSearchingAll": "Searching Pi's full official catalog…",
    "i18n.pluginCatalogSearchComplete": "Official catalog search returned {count} results.",
    "i18n.pluginCatalogSearchFailed": "Official search is temporarily unavailable. Matching local catalog entries are still shown.",
    "i18n.pluginCatalogSearchStaleWarning": "Official search is temporarily unavailable. The latest cached search is shown.",
    "i18n.pluginMonthlyDownloads": "{count} downloads/month",
    "i18n.pluginDetails": "Details",
    "i18n.pluginInstallFromCommunity": "Install",
    "i18n.pluginNoCommunityResults": "No community plugins match this filter.",
    "i18n.pluginRiskLow": "Lower risk",
    "i18n.pluginRiskReview": "Review first",
    "i18n.pluginInstallProgressTitle": "Installing plugin",
    "i18n.pluginInstallProgressBackground": "running in the background",
    "i18n.pluginInstallStagePreparing": "Preparing",
    "i18n.pluginInstallStageDownloading": "Downloading",
    "i18n.pluginInstallStageInstalling": "Installing",
    "i18n.pluginInstallStageFinalizing": "Finishing",
    "i18n.pluginInstallWarningTitle": "Review before installing",
    "i18n.pluginInstallWarningBody": "Third-party packages can run local code with the same permissions as Magent. Install only sources you trust; changing activation takes effect after a session reload.",
    "i18n.pluginInstallWarningSource": "Source",
    "i18n.pluginInstallWarningAcknowledge": "I understand this package runs with Magent's local permissions.",
    "i18n.pluginInstallWarningContinue": "Continue installation",
    "i18n.builtinPluginsTitle": "Starter capabilities",
    "i18n.builtinPluginBadge": "Built-in",
    "i18n.builtinPluginsDescription": "Common capabilities are prepared on first launch. Official packages stay unmodified, so you can update or disable them later.",
    "i18n.builtinPluginsDisclaimer": "Source: Pi official community · npm registry {registry} · executable packages still run with Magent permissions.",
    "i18n.builtinPluginsReloadHint": "If this session was already open, reload it once before using a newly prepared capability.",
    "i18n.builtinPluginProgress": "Preparing {done}/{total}",
    "i18n.builtinPluginLoading": "Reading starter capability status…",
    "i18n.builtinPluginPending": "Waiting",
    "i18n.builtinPluginInstalling": "Preparing",
    "i18n.builtinPluginReady": "Ready",
    "i18n.builtinPluginMissing": "Retry needed",
    "i18n.builtinPluginFailed": "Failed",
    "i18n.builtinPluginConflict": "Kept existing",
    "i18n.builtinPluginRetry": "Retry",
    "i18n.builtinPluginRetrying": "Retrying…",
    "i18n.builtinNoticeTitle": "Preparing starter capabilities",
    "i18n.builtinNoticeBody": "MeteorAgent is preparing web, document, image, and computer-use tools from Pi's official community. Computer use starts off per session; executable packages still run with Magent's local permissions and can be reviewed, updated, or disabled in Settings → Plugins.",
    "i18n.builtinNoticeProgress": "Preparing in the background: {progress}",
    "i18n.builtinNoticeManage": "View plugins",
    "i18n.builtinNoticeDismiss": "Got it",
    "i18n.pluginActivationMode": "Activation scope",
    "i18n.pluginActivationGlobal": "All sessions",
    "i18n.pluginActivationSession": "Choose per session",
    "i18n.pluginActivationGlobalDescription": "This package is available in every new session after reload.",
    "i18n.pluginActivationSessionDescription": "This package starts off in new sessions and can be enabled from that session's plugin picker.",
    "i18n.pluginActivationSaving": "Saving activation scope…",
    "i18n.pluginActivationSaved": "Activation scope saved. Reload the session to apply it.",
    ...
    "chat.codeLines": "{count} lines of code",
    ...
    // relay module
    "relay.onboarding.title": "Connect meteor21c relay",
    "relay.onboarding.description": "Add a meteor21c relay token to start routing requests through the relay.",
    "relay.onboarding.tokenLabel": "API token",
    "relay.onboarding.tokenPlaceholder": "Paste your meteor21c token",
    "relay.onboarding.getToken": "Get token",
    "relay.onboarding.test": "Test connection",
    "relay.onboarding.testing": "Testing…",
    "relay.onboarding.save": "Save",
    "relay.onboarding.saving": "Saving…",
    "relay.onboarding.success": "Relay connected.",
    "relay.onboarding.invalidKey": "API key rejected. Check the token and try again.",
    "relay.onboarding.networkError": "Network error. Try again.",
    "relay.onboarding.modelsFound": "Connected. {count} models available.",
    "relay.usage.title": "Relay usage",
    "relay.usage.balance": "Relay balance",
    "relay.usage.today": "Today",
    "relay.usage.todayCost": "Today cost",
    "relay.usage.todayRequests": "Today requests",
    "relay.usage.topModels": "Top models",
    "relay.usage.model": "Model",
    "relay.usage.requests": "Requests",
    "relay.usage.cost": "Cost",
    "relay.usage.refresh": "Refresh",
    "relay.usage.refreshing": "Refreshing…",
    "relay.usage.failed": "Usage query failed.",
    "relay.usage.noData": "No usage data yet.",
    "relay.usage.updatedAt": "Updated {time}",
    "relay.usage.invalidKey": "No relay API key configured.",
    "relay.usage.tokens": "Tokens",
    "relay.usage.actualCharge": "Actual relay charge (synced)",
    "relay.usage.estimatedCharge": "Catalogue estimate; no matching relay charge yet",
    "relay.usage.estimatedChargeShort": "Cost",
    "relay.usage.intermediateStats": "Intermediate request stats; the final reply summarizes the whole turn",
    "relay.usage.turnSummary": "Turn summary · {label}",
    "relay.usage.imageCharge": "Image {cost}",
    "relay.usage.imageChargeSynced": "Image charge · {count} generation(s) · synced",
    "relay.usage.imageChargePending": "Image charge · {count} item(s) waiting for relay sync",
    "relay.usage.syncing": "Syncing",
    // brand auth & advanced
    "brand.auth.title": "Sign in",
    "brand.auth.description": "Sign in with your meteor21c account — we'll set everything up for you.",
    "brand.auth.email": "Email",
    "brand.auth.password": "Password",
    "brand.auth.login": "Sign in",
    "brand.auth.loggingIn": "Signing in…",
    "brand.auth.registerHint": "Don't have an account? Create one",
    "brand.auth.loginFailed": "Incorrect email or password.",
    "brand.auth.networkError": "Network error. Please try again.",
    "brand.auth.captchaRequired": "Verification required. Please try again.",
    "brand.auth.autoSetup": "Setting up your models automatically…",
    "brand.auth.autoKeyCreate": "No API key found. Creating one for you…",
    "brand.auth.ready": "Connected. {count} models in your catalog.",
    "brand.auth.checking": "Checking your account…",
    "brand.auth.retry": "Try again",
    "brand.auth.catalogOnly": "Model catalogs are connected. Actual availability and charges depend on your plan; no paid test was run.",
    "brand.setup.title": "Preparing MeteorAgent",
    "brand.setup.readyTitle": "MeteorAgent is ready",
    "brand.account.title": "MeteorAgent account",
    "brand.account.switchLogout": "Sign out / switch account",
    "brand.account.logoutHint": "Signing out removes account-synced credentials. Local conversations and manually added keys are kept. Running tasks may still finish.",
    "brand.account.confirmLogout": "Sign out and remove account-synced credentials? Local conversations and manually added keys will remain. Stop running tasks first if needed.",
    ...
    "relay.advanced.proxy": "Connection troubleshooting",
    "relay.advanced.proxyHint": "Can't connect? Start the app with HTTPS_PROXY, e.g. HTTPS_PROXY=http://127.0.0.1:7890 webagent",
    "relay.advanced.modelsSync": "Your model list follows your plan automatically.",
    "brand.keys.noKeyTitle": "No API key on your account yet.",
    "brand.keys.noKeyHint": "Create one in the meteor21c console, then click Refresh keys here to sync it.",
    "brand.keys.refresh": "Refresh keys",
    "brand.keys.refreshing": "Syncing…",
    "brand.keys.updated": "Channels synced. {count} models in the catalog.",
    "brand.keys.partial": "{count} channel(s) could not be updated. You can use the connected channels and retry later.",
    "brand.keys.consoleLink": "Open meteor21c console",
    "brand.keys.refreshFailed": "Sync failed. Please try again.",
