...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "i18n.pluginCommunityDescription": "A small, low-risk selection from the Pi package catalog.",
    ...
    "i18n.pluginLowRiskNotice": "Shown in risk order: skills and prompts first, then executable tool candidates. Themes, shortcuts, TUI, animation, and provider packages stay out of this view.",
    ...
    "i18n.pluginComplexHidden": "Complex packages are hidden from this curated view.",
