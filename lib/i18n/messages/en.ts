...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "i18n.builtinNoticeBody": "MeteorAgent is preparing common web, document, and image tools from Pi's official community. Executable packages run with the same local permissions as Magent; review, update, or disable them later in Settings → Plugins.",
